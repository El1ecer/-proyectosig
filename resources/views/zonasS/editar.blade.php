...
<div class="container mt-4">
    <div class="card shadow border rounded-3">
        <div class="card-header bg-primary">
            <h3 class="mb-0 text-white">Edita la zona segura</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('zonasS.update', $zona->id) }}" method="POST" enctype="multipart/form-data" id="frmZonaS">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6 d-flex flex-column justify-content-between">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" value="{{ $zona->radio }}" name="radio" id="radio" placeholder="Ingrese el radio de la zona segura">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="custom-select" name="tipoSeguridad" id="tipoSeguridad">
                                <option value="Bajo" {{ $zona->tipoSeguridad == 'Bajo' ? 'selected' : '' }}>Bajo</option>
                                <option value="Medio" {{ $zona->tipoSeguridad == 'Medio' ? 'selected' : '' }}>Medio</option>
                                <option value="Alto" {{ $zona->tipoSeguridad == 'Alto' ? 'selected' : '' }}>Alto</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" value="{{ $zona->latitud }}" class="form-control" name="latitud" id="latitud" readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="longitud" class="form-label"><strong>Longitud:</strong></label>
                                    <input type="text" value="{{ $zona->longitud }}" class="form-control" name="longitud" id="longitud" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
